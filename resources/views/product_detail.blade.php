...
<!-- Mirrored from template-preview.com/bootstrap-templates/flextop/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Apr 2018 07:21:55 GMT -->
<head>
<title>Flex Bootstrap responsive ecommerce template - Product Details</title>
<meta charset="utf-8">
...
<body class="not-front page-product-details">
...
<div class="breadcrumbs1_wrapper">
  <div class="container">
    <div class="breadcrumbs1"><a href="index-2.html">Home</a><span></span><a href="index-2.html">TV & Audio</a><span></span>Widescreen 55’’ LED4K Ultra HD</div>
  </div>
</div>
...
<div class="container">
    ...
    <div class="col-sm-6">
      ...
      <div class="gslider-wrapper">
        <div id="gslider2" class="flexslider flexslider-gslider">
          <ul class="slides">
            <li>
              <img src="{{asset('images/gallery01.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/gallery02.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/gallery03.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/gallery04.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/gallery01.jpg')}}" alt="" class="img-responsive">
            </li>
        ...
        <div id="carousel2" class="flexslider flexslider-carousel">
          <ul class="slides">
            <li>
              <img src="{{asset('images/thumb01.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/thumb02.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/thumb03.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/thumb04.jpg')}}" alt="" class="img-responsive">
            </li>
            <li>
              <img src="{{asset('images/thumb01.jpg')}}" alt="" class="img-responsive">
            </li>
 ...
 @foreach($data as $post)
      ...
      <img src= "<?php echo public_path() . 'public/images/' . '{{$post->image}}'; ?>
">
        ...
        <div class="product-share clearfix">
          ...
          <div class="product-share-list"><a href="#"><img src="{{asset('images/share1.png')}}" alt="" class="img-responsive"></a><a href="#"><img src="{{asset('images/share2.png')}}" alt="" class="img-responsive"></a><a href="#"><img src="{{asset('images/share3.png')}}" alt="" class="img-responsive"></a><a href="#"><img src="{{asset('images/share4.png')}}" alt="" class="img-responsive"></a></div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="modalNewsletterMan">
          <img src="{{asset('images/newsletterman.png')}}" alt="" class="img-responsive">
        </div>
      </div>
    </div>
  </div>
