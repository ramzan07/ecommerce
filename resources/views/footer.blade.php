...
<link rel="stylesheet" href="{{asset('adminpanel/css/bootstrap-responsive.min.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/colorpicker.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/datepicker.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/uniform.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/select2.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/matrix-style.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/matrix-media.css')}}" />
<link rel="stylesheet" href="{{asset('adminpanel/css/bootstrap-wysihtml5.css')}}" />
...
<script src="{{asset('adminpanel/js/jquery.ui.custom.js')}}"></script> 
<script src="{{asset('adminpanel/js/bootstrap.min.js')}}"></script> 
<script src="{{asset('adminpanel/js/bootstrap-colorpicker.js')}}"></script> 
<script src="{{asset('adminpanel/js/bootstrap-datepicker.js')}}"></script> 
<script src="{{asset('adminpanel/js/jquery.toggle.buttons.js')}}"></script> 
<script src="{{asset('adminpanel/js/masked.js')}}"></script> 
<script src="{{asset('adminpanel/js/jquery.uniform.js')}}"></script> 
<script src="{{asset('adminpanel/js/select2.min.js')}}"></script> 
<script src="{{asset('adminpanel/js/matrix.js')}}"></script> 
<script src="{{asset('adminpanel/js/matrix.form_common.js')}}"></script> 
<script src="{{asset('adminpanel/js/wysihtml5-0.3.0.js')}}"></script> 
<script src="{{asset('adminpanel/js/jquery.peity.min.js')}}"></script> 
<script src="{{asset('adminpanel/js/bootstrap-wysihtml5.js')}}"></script> 
<script>
